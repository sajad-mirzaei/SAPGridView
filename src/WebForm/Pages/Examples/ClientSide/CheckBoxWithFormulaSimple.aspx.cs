...
public partial class CheckBoxWithFormulaSimple : System.Web.UI.Page
{
    ...
    public List<CheckBoxWithFormulaSimpleModel> FakeList()
    {
        List<CheckBoxWithFormulaSimpleModel> oData = new List<CheckBoxWithFormulaSimpleModel>();
        for (int i = 1; i <= 100; i++)
        {
            CheckBoxWithFormulaSimpleModel row = new CheckBoxWithFormulaSimpleModel();
            row.id = i;
            row.price = i * 10;
            row.x2 = "Name1 " + i + 1;
            row.x3 = "Name2 " + i + 2;
    ...
    public class CheckBoxWithFormulaSimpleModel
    {
