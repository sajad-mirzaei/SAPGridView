<%@ Page Title="گزارش تست" Language="C#" MasterPageFile="~/MainBoard.master" AutoEventWireup="true" CodeFile="Grid_ChartColumn.aspx.cs" Inherits="Grid_ChartColumn" %>
        ...
        <ContentTemplate>
            ...
            <div class="FormBox">
                ...
                <div class="ContentBox">
                    <div id="columnChartContainer" style="margin-bottom: 1em;" class="chart-display"></div>
                    <div id="MyGridId"></div>
                </div>
            </div>
