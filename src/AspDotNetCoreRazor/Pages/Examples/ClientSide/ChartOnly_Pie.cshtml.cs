...
{
    public class ChartOnly_Pie : PageModel
    {
        private readonly ILogger<ChartOnly_Pie> _logger;
        public ChartOnly_Pie(ILogger<ChartOnly_Pie> logger)
        {
            _logger = logger;
        }
        ...
        {
            List<ChartOnly_PieModel> dt = new ChartOnly_PieData().GetData();
    ...
    public class ChartOnly_PieData
    {
        public List<ChartOnly_PieModel> GetData()
        {
            var d = new List<ChartOnly_PieModel>
            {
    ...
    public class ChartOnly_PieModel
    {
