...
{
    public class ChartMutiple : PageModel
    {
        private readonly ILogger<ChartMutiple> _logger;
        public ChartMutiple(ILogger<ChartMutiple> logger)
        {
            _logger = logger;
        }
        ...
        {
            List<ChartMutipleModel> dt = new ChartMutipleData().GetData();
    ...
    public class ChartMutipleData
    {
        public List<ChartMutipleModel> GetData()
        {
            var d = new List<ChartMutipleModel>
            {
    ...
    public class ChartMutipleModel
    {
