...
{
    public class ChartLine : PageModel
    {
        private readonly ILogger<ChartLine> _logger;
        public ChartLine(ILogger<ChartLine> logger)
        {
            _logger = logger;
        }
        ...
        {
            List<ChartLineModel> dt = new ChartLineData().GetData();
    ...
    {
        public List<ChartLineModel> GetData()
        {
            var d = new List<ChartLineModel>
            {
